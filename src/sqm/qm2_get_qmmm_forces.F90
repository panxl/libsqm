...
!Passed in
      ...
      _REAL_ , intent(out) :: mm_esp(4,qmmm_struct%qm_mm_pairs)
...
!        on current qm atom.
         ...
         if (spd_atom) then
          ...
          do j=1,qmmm_struct%qm_mm_pairs
              ...
              ! electric field
              mm_esp(2,j) = pair_force(1)
              mm_esp(3,j) = pair_force(2)
              mm_esp(4,j) = pair_force(3)
