...
integer nrp,nspm,ig,ntx,ntcx,            &!5
      ...
      mask_from_ref,hidx, reservoir_exchange_step,ionstepvelocities, iextpot !93
...
parameter (BC_MDI=93) ! Number of elements in the common block;
...
_REAL_ t,dt,temp0,tautp,pres0,comp,taup,temp,tempi, & !9
      ...
      screen_pnu, fswitch, sinrtau, solve  !97
...
parameter (BC_MDR=97) ! Number of elements in the common block;
                      ! Be sure to update if you change things
